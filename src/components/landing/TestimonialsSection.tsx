      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          {testimonials.map((testimonial, index) => (
            <div 
              ...
              className="p-8 rounded-2xl bg-card shadow-soft hover:shadow-elevated transition-shadow duration-300 animate-fade-in-up"
        ...
        <div className="mt-16 pt-16 border-t border-border">
          ...
          <div className="flex flex-wrap justify-center items-center gap-8 md:gap-16 opacity-60">
            {["Bosch", "Mercedes-Benz", "SAP", "Siemens"].map((company) => (
              <div 
                key={company}
                className="px-6 py-3 rounded-lg bg-muted text-muted-foreground font-semibold"
              >
                {company}
              </div>
            ))}

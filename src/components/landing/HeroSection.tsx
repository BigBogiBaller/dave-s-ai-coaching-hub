        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className={`space-y-8 transition-all duration-1000 ease-out ${isLoaded ? "translate-y-0 opacity-100" : "translate-y-12 opacity-0"}`}>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button size="lg" onClick={scrollToBooking} className="bg-primary hover:bg-primary/90 text-lg px-8 py-6 shadow-elevated hover:scale-105 transition-transform duration-300">
